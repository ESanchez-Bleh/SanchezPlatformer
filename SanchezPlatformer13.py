            ...
            for platform in platform_group:
                ...
                if platform.rect.colliderect(self.rect.x, self.rect.y + dy, self.width, self.height):
                    ...
                    #check if above platform
                        ...
                        self.rect.bottom = platform.rect.top - 0.7
                        self.in_air = False
                        dy = 0
    ...
    def __init__(self, data):
        ...
        for row in data:
            ...
            for tile in row:
                ...
                if tile == 5:
                    platfrom = Platform(col_count * tile_size, row_count * tile_size, 0, 1)
